            ...
            <div class="swiper products-swiper">
                <div class="swiper-wrapper">
                    <?php while ($loop->have_posts()) : $loop->the_post(); ?>
                        ...
                        $on_sale_simple = $product->is_type('simple')
                                && $product->is_on_sale()
                                && $regular_price !== ''
                                && $sale_price !== ''
                                && floatval($sale_price) < floatval($regular_price);
                ...
                <div class="slider-arrow slider-arrow--prev">
                    <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/arrow-left.svg'); ?>"
                         alt="Назад">
                </div>
                ...
                <div class="swiper-scrollbar swiper-scrollbar--products">
                    <div class="swiper-scrollbar-arrow swiper-scrollbar-arrow--prev">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/polygon-left.svg'); ?>"
                             alt="Назад">
                    </div>
                    <div class="swiper-scrollbar-arrow swiper-scrollbar-arrow--next">
                        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/icons/polygon-right.svg'); ?>"
                             alt="Вперёд">
                    </div>
                </div>
